#!/usr/bin/env node
/**
 * Flexible release script for Satsu
 *
 * Features:
...
// Main release flow
async function main() {
  console.log('🚀 Satsu Release Script\n');
  ...
  if (!options.skipRelease) {
    ...
    const releaseNotesFile = '/tmp/satsu-release-notes.md';
    ...
    if (options.github) {
      ...
      const githubRepo = process.env.GITHUB_REPO || 'sharkhunterr/satsu';
